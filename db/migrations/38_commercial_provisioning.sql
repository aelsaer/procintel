-- 38_commercial_provisioning.sql
-- Stable OIDC-subject routing and least-privilege organization provisioning.

CREATE TABLE IF NOT EXISTS oidc_subject_tenant_bindings (
...
CREATE INDEX IF NOT EXISTS ix_oidc_binding_tenant
    ON oidc_subject_tenant_bindings (tenant_id, user_id);
...
GRANT SELECT, INSERT, UPDATE ON oidc_subject_tenant_bindings TO procintel_app;
